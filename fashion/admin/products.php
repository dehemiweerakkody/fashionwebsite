...
$result = $mysqli->query("SELECT * FROM products Order BY p_id DESC");
?>
...
<!-- <?php
        ...
        $totalWebSQL = "SELECT * FROM products";
        ...
        $productSQL = "SELECT *
FROM `products` Order BY p_id DESC LIMIT $startFrom, $showRecordPerPage";
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="#addWebModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($productResult as $row) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" style="color:#fff" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $row['p_id'];?>">
                                                            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                                        </a>

                                                        <a onClick="slotDelete('<?php echo $row['p_id']; ?>')" style="color:#fff" class="btn btn-sm btn-Danger">
